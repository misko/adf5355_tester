"""Process entry point shared by `python -m adf5355` and the console script.
...
def run() -> None:
    """Run the CLI and leave without letting the interpreter finalize."""
    from .cli import main  # imported late so the hook is installed first
